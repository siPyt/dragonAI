...
const combos: Combo[] = [
  ...
  { type: 'Direct Attack', call: 'Lead Body Jab', source: 'Pro Boxing Fundamentals' },
  { type: 'Direct Attack', call: 'Step-in Cross', source: 'Pro Boxing Fundamentals' },
  { type: 'Direct Attack', call: 'Lead Hook to Head', source: 'Pro Boxing Fundamentals' },
  { type: 'Direct Attack', call: 'Rear Shovel Hook', source: 'Pro Boxing Advanced' },
  { type: 'Direct Attack', call: 'Lead Long Jab', source: 'Pro Boxing Fundamentals' },
  { type: 'Direct Attack', call: 'Rear Straight to Body', source: 'Pro Boxing Fundamentals' },
  // Attack by Drawing
  ...
  { type: 'Boxing Trapping', call: 'Parry, clinch, then break and cross', source: 'Pro Boxing Advanced' },
  { type: 'Boxing Trapping', call: 'Catch and frame, then pivot and hook', source: 'Pro Boxing Advanced' },
  { type: 'Boxing Trapping', call: 'Hand control, step around, then cross', source: 'Pro Boxing Advanced' },
  { type: 'Boxing Trapping', call: 'Parry, shoulder bump, then uppercut', source: 'Pro Boxing Advanced' },
  { type: 'Boxing Trapping', call: 'Frame, clinch, then lead hook', source: 'Pro Boxing Advanced' },
  { type: 'Boxing Trapping', call: 'Double hand control, then rear uppercut', source: 'Pro Boxing Advanced' },
  { type: 'Boxing Trapping', call: 'Parry, tie up, then pivot and cross', source: 'Pro Boxing Advanced' },
  ...
  { type: 'Attack by Combination', call: 'Jab, cross, slip, rear cross', source: 'Pro Boxing Fundamentals' },
  { type: 'Attack by Combination', call: 'Jab, cross, lead hook, slip, cross', source: 'Pro Boxing Advanced' },
];
