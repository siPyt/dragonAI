...
const criteria = [
  {
    ...
    requirements: [
      ...
      'Execute all basic punches and kicks with correct form (video review)',
  ...
  },
  {
    ...
    requirements: [
      ...
      'Show ability to flow between all ranges (kicking, punching, trapping, grappling)',
  ...
  },
  {
    ...
    requirements: [
      ...
      'Demonstrate all Fighter skills plus: advanced trapping, clinch, takedown defense',
  ...
  },
  {
    ...
    requirements: [
      ...
      'Demonstrate all Practitioner skills plus: advanced sparring, scenario drills',
  ...
  },
  {
    ...
    requirements: [
      ...
      'Show mastery in all ranges, under pressure, with video review',
